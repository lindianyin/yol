...
tbStageSetting[7] =
{
	...
	-- 		编号  	npc模板				等级(-1默认随机npcpro表)	5行(默认-1)
		   ...
		   [2] = {nTemplate = 1001, nLevel = 35, nSeries = -1},		-- 石头中1
		   [3] = {nTemplate = 1002, nLevel = 35, nSeries = -1},		-- 石头中2
		   [4] = {nTemplate = 1003, nLevel = 35, nSeries = -1},		-- 石头左1
		   [5] = {nTemplate = 1004, nLevel = 35, nSeries = -1},		-- 石头左2
		   [6] = {nTemplate = 1005, nLevel = 35, nSeries = -1},		-- 石头右1
		   [7] = {nTemplate = 1006, nLevel = 35, nSeries = -1},		-- 石头右2
		   [8] = {nTemplate = 1007, nLevel = 25, nSeries = -1},		-- 自杀
		   [9] = {nTemplate = 1008, nLevel = 25, nSeries = -1},		-- 定时炸弹
		   [10] = {nTemplate = 1009, nLevel = 35, nSeries = -1},		-- 石龟
		   ...
		   [15] = {nTemplate = 1014, nLevel = 35, nSeries = -1},		-- 超级巨石（山坡）
		   [16] = {nTemplate = 1015, nLevel = 35, nSeries = -1},		-- 超级巨石（山坡）
		   ...
		   [21] = {nTemplate = 1022, nLevel = 35, nSeries = -1},		-- 巨石怪（攻击）
		   [22] = {nTemplate = 1023, nLevel = 35, nSeries = -1},		-- 石头支援BOSS
		   [23] = {nTemplate = 1024, nLevel = 35, nSeries = -1},		-- 石头支援BOSS
		   [24] = {nTemplate = 1025, nLevel = 35, nSeries = -1},		-- 石头支援BOSS
		   [25] = {nTemplate = 1026, nLevel = -1, nSeries = -1},		-- 透明被杀
		   [26] = {nTemplate = 1027, nLevel = 35, nSeries = -1},		-- 石龟
		   [27] = {nTemplate = 1028, nLevel = 35, nSeries = -1},		-- 炸弹龟
		   [28] = {nTemplate = 1029, nLevel = 1, nSeries = -1},		-- 透明目标
		   [29] = {nTemplate = 1017, nLevel = 35, nSeries = -1},		-- 石头新增左
		   [30] = {nTemplate = 1018, nLevel = 35, nSeries = -1},		-- 石头新增右
	},
...
tbStageSetting[8]=
{
	...
	-- 		编号  	npc模板				等级(-1默认)	5行(默认-1)
		   ...
		   [11] = {nTemplate = 1060, nLevel = 35, nSeries = -1},		-- 魔兵
		   [12] = {nTemplate = 1061, nLevel = 35, nSeries = -1},		-- 魔兵弓箭手
		   [13] = {nTemplate = 1062, nLevel = 35, nSeries = -1},		-- 魔将
		   [14] = {nTemplate = 1063, nLevel = 35, nSeries = -1},		-- 魔将
		   [15] = {nTemplate = 1064, nLevel = 35, nSeries = -1},		-- 怨灵
		   [16] = {nTemplate = 1065, nLevel = -1, nSeries = -1},		-- 圣光
		   [17] = {nTemplate = 1066, nLevel = 35, nSeries = -1},		-- 妖王
		    [18] = {nTemplate = 1067, nLevel = -1, nSeries = -1},		-- 一出来就自杀
		   [19] = {nTemplate = 1068, nLevel = 35, nSeries = -1},		-- 缸
		   [20] = {nTemplate = 1069, nLevel = 1, nSeries = -1},		-- 人踩自杀
		   [21] = {nTemplate = 1070, nLevel = 35, nSeries = -1},		-- 鬼魂
		   [22] = {nTemplate = 1071, nLevel = 35, nSeries = -1},		-- 鬼魂
		   [23] = {nTemplate = 1072, nLevel = 35, nSeries = -1},		-- 鬼魂
		   [24] = {nTemplate = 1073, nLevel = 35, nSeries = -1},		-- 鬼魂
		    [25] = {nTemplate = 1074, nLevel = 35, nSeries = -1},		-- 凶猛鬼魂
			[26] = {nTemplate = 1075, nLevel = 35, nSeries = -1},		-- 召唤鬼魂
		   [27] = {nTemplate = 1076, nLevel = 35, nSeries = -1},		-- 召唤鬼魂
		   [28] = {nTemplate = 1077, nLevel = 35, nSeries = -1},		-- 召唤鬼魂
		   [29] = {nTemplate = 1078, nLevel = 35, nSeries = -1},		-- 召唤鬼魂
		   [30] = {nTemplate = 1079, nLevel = -1, nSeries = -1},		-- 透明被杀
			...
			[34] = {nTemplate = 1083, nLevel = 35, nSeries = -1},		-- 凶鬼
	},
    LOCK =
    {
       -- 1号锁不能不填，默认1号为起始锁
...
tbStageSetting[9] =
{
	...
	{
	-- 		编号  	npc模板				等级(-1默认随机npcpro表)	5行(默认-1)
	  [1] = {nTemplate = 1200, nLevel = 30, nSeries = -1},		-- 大将军
	  [2] = {nTemplate = 1201, nLevel = -1, nSeries = -1},		-- 火焰
	  [3] = {nTemplate = 1202, nLevel = 1, nSeries = -1},		-- 自杀
	  [4] = {nTemplate = 1203, nLevel = -1, nSeries = -1},		-- 闪电
	  [5] = {nTemplate = 1204, nLevel = 30, nSeries = -1},		-- 被杀
	  [6] = {nTemplate = 1205, nLevel = 30, nSeries = -1},		-- 将军分身
	  [7] = {nTemplate = 1206, nLevel = 30, nSeries = -1},		-- 龙卷风
