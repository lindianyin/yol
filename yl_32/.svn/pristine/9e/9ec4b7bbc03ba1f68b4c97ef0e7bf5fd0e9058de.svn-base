...
local tb	= Task:GetTarget("CastSkillAtArea");
tb.szTargetName	= "CastSkillAtArea";



function tb:Init(tbItemId, nSkillId, nMapId, nPosX, nPosY, nPosZ, nR, szExtraPos)
	if (tbItemId[1] ~= 20) then
		print("[Task Error]"..self.szTargetName..Lang.task.target.str13[Lang.Idx])
	end
