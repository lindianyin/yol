...
local tb	= Task:GetTarget("SweepDTT");
tb.szTargetName	= "SweepDTT";
...
function tb:Start()
	self.bDone = 1;
	local nSweepCountLeft = Player.tbDegree:GetDegree(self.me, "MopTower")
	local nMaxSweepCount = Player.tbDegree:GetMaxDegree(self.me, "MopTower")
