...
-- E.g  [0] = {nTemplate, 			nLevel, 		nSeries }
		[1] = {nTemplate = 9002, nLevel = {9002,9002,9002}, nSeries = -1},		-- 无上精英弟子
		[2] = {nTemplate = 9021, nLevel = {9021,9021,9021}, nSeries = -1},		-- 李晓
		[3] = {nTemplate = 9040, nLevel = {9021,9021,9021}, nSeries = -1},          --替身
	...
	[3] = {nTime = 0, nNum = 3,       --刷第一波怪
		tbPrelock = {1},
			tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 3, 3, "guaiwu", "jingying9002"},		-- 刷怪
				{XoyoGame.ADD_NPC, 3, 1, 0, "tishen", "tishen9021"},
	...
	[4] = {nTime = 0, nNum = 3,      --刷第二批怪
		tbPrelock = {3},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 3, 4, "guaiwu", "jingying9002"},		-- 刷怪
	...
	[5] = {nTime = 0, nNum = 4,      --刷第三批怪
		tbPrelock = {4},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 4,5, "guaiwu", "jingying9002"},		-- 刷怪
	...
	[6] = {nTime = 0, nNum = 4,      --刷第四批怪
		tbPrelock = {5},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 4, 6, "guaiwu", "jingying9002"},		-- 刷怪
	...
	[7] = {nTime = 0, nNum = 4,      --刷第五批怪
		tbPrelock = {6},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 4, 7, "guaiwu", "jingying9002"},		-- 刷怪
	...
	[8] = {nTime = 0, nNum = 5,      --刷第六批怪
		tbPrelock = {7},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 5,8, "guaiwu", "jingying9002"},		-- 刷怪
	...
	[9] = {nTime = 0, nNum = 5,      --刷第七批怪
		tbPrelock = {8},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 5, 9, "guaiwu", "jingying9002"},		-- 刷怪
	...
	[10] = {nTime = 0, nNum = 6,      --刷第八批怪
		tbPrelock = {9},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 6, 10, "guaiwu", "jingying9002"},		-- 刷怪
	...
	[12] = {nTime = 0, nNum = 5,      --刷BOSS
		tbPrelock = {11},
			...
			{
				{XoyoGame.DEL_NPC, "tishen"},
				{XoyoGame.ADD_NPC, 1, 4, 12, "guaiwu", "jingying9002"},		-- 刷怪
				{XoyoGame.ADD_NPC, 2, 1, 12, "boss", "lixiaofu9021"},		-- 刷怪
				{XoyoGame.TARGET_INFO, -1, Lang.mission.str578[Lang.Idx],12},
