...
struct C2G_RANDOM_PLAYERNAME_REQUEST : KGC_PROTOCOL_HEADER
{
	INT nSex;
};
...
struct G2C_ACCOUNT_VERIFY_RESPOND : KGC_PROTOCOL_HEADER
{
	...
	DWORD   dwLastLoginIP;
	DWORD dwLimitPlayTimeFlag;
	int     nZoneID; // 玩家登录的区服ID
};
...
struct G2C_RANDOM_PLAYERNAME : KGC_PROTOCOL_HEADER
{
	INT nSex;
