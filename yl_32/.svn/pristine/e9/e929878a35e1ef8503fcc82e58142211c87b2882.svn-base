...
function AI:Setup(ai)
    ...
    g_AIDebugInfo[177] = '[177] SetParam(State6)'
    ...
    g_AIDebugInfo[179] = '[179] SetParam(State29)'
    ...
    action.SetParam(127, 1)
    action.SetBranch(117, 117)
    g_AIDebugInfo[34] = '[34] CAST_SKILL(127, 1)'
    ...
    g_AIDebugInfo[181] = '[181] SetParam(State60)'
    ...
    g_AIDebugInfo[183] = '[183] SetParam(State69)'
    ...
    g_AIDebugInfo[185] = '[185] SetParam(State127)'
    ...
    g_AIDebugInfo[187] = '[187] SetParam(State40)'
    ...
    g_AIDebugInfo[189] = '[189] SetParam(State137)'
    ...
    g_AIDebugInfo[191] = '[191] SetParam(State91)'
    ...
    action.SetParam(126, 1)
    action.SetBranch(148, 148)
    g_AIDebugInfo[43] = '[43] CAST_SKILL(126, 1)'
    ...
    -- 设置状态
    action = ai.NewAction(193, AI_ACTION.SET_STATE)
    action.SetParam(97) -- 攻击状态2
    g_AIDebugInfo[193] = '[193] SetParam(State97)'
    ...
    -- 设置状态
    action = ai.NewAction(195, AI_ACTION.SET_STATE)
    action.SetParam(164) -- 追击状态
    g_AIDebugInfo[195] = '[195] SetParam(State164)'
    ...
    g_AIDebugInfo[155] = '[155] CAST_SKILL(127, 1)'
...
-- 本AI图内自定义脚本
function AI:CustomAction93(pNpc, talkingStr)
    -- 输入自定义动作实现脚本
