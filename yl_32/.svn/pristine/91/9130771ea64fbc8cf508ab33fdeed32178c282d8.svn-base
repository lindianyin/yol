...
{
	ACCOUNT_LIMITTIME_FLAG_NOINFO_NOTLIMIT	= 0,	// 无实名信息，不属于防沉迷管辖范围
	ACCOUNT_LIMITTIME_FLAG_NOINFO_LIMIT		= 1,	// 无实名信息，属于防沉迷管辖范围
	ACCOUNT_LIMITTIME_FLAG_INFO_NOTLIMIT		= 2,	// 有实名信息，不属于防沉迷管辖范围
	ACCOUNT_LIMITTIME_FLAG_INFO_LIMIT		= 3,	// 有实名信息，属于防沉迷管辖范围

	// 新增
	UNLIMIT_NEW_ACCOUNT_EX = 5, // 用户既有身份证又有联系方式，不纳入防沉迷
	LIMIT_NEW_ACCOUNT_EX = 6, // 用户既有身份证又有联系方式，纳入防沉迷
	UNLIMIT_NO_ID_CARD_INFO = 7, // 用户有联系方式，没有身份证，不纳入防沉迷
	UNLIMIT_NO_CONTACT_INFO = 8, // 用户有身份证，没有联系方式，不纳入防沉迷
	UNLIMIT_NO_ALL_INFO = 9, // 用户既没有身份证，也没有联系方式，不纳入防沉迷
	LIMIT_NO_ID_CARD_INFO = 10, // 用户有联系方式，没有身份证，纳入防沉迷
	LIMIT_NO_CONTACT_INFO = 11, // 用户有身份证，没有联系方式，纳入防沉迷
	LIMIT_NO_ALL_INFO = 12, // 用户既没有联系方式，也没有身份证，纳入防沉迷
