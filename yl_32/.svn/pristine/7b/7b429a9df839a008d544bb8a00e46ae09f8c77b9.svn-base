...
function tb:Init(nMapId, nMapPosX, nMapPosY, nMapPosZ, nDialogNpcTempId, szOption, szMsg, nFightNpcTempId, nFightNpcLevel, nDeathDuration, szBeforePop, szLaterPop)
	self.nMapId				= nMapId;
