...
tbMultiSetting[500]=
   {
	...
	-- 		编号  	npc模板				等级(-1默认随机npcpro表)	5行(默认-1)
		   ...
		   [2] = {nTemplate = 1001, nLevel = 35, nSeries = -1},		-- 石头中1   用
		   [3] = {nTemplate = 1002, nLevel = 35, nSeries = -1},		-- 石头中2   用
		   ...
		   [8] = {nTemplate = 1007, nLevel = 35, nSeries = -1},		-- 自杀
		   [9] = {nTemplate = 1008, nLevel = 35, nSeries = -1},		-- 第一波龟（新）
		   [10] = {nTemplate = 1009, nLevel = 35, nSeries = -1},		-- 石龟
		   [11] = {nTemplate = 1010, nLevel = -1, nSeries = -1},		-- 墙！！
		   [12] = {nTemplate = 1011, nLevel = 35, nSeries = -1},		-- 假
		   [13] = {nTemplate = 1012, nLevel = 35, nSeries = -1},		-- 真
		   [14] = {nTemplate = 1013, nLevel = -1, nSeries = -1},		-- 定身
		   [15] = {nTemplate = 1014, nLevel = 35, nSeries = -1},		-- 巨型龟
		   [16] = {nTemplate = 1015, nLevel = 35, nSeries = -1},		-- 巨石龟（新）
		   [17] = {nTemplate = 1016, nLevel = 35, nSeries = -1},		-- 真东西！！
		   ...
		   [27] = {nTemplate = 1028, nLevel = 35, nSeries = -1},		-- 困难用水晶
		   ...
		   [31] = {nTemplate = 1030, nLevel = 35, nSeries = -1},		-- 防御石柱
	},
    ...
    LOCK =
    {
       -- 1号锁不能不填，默认1号为起始锁
		...
		[5] = {nTime = 10, nNum = 0 ,		-- 石头（为了让石头不同时间滚下）
			tbPrelock = {3},
			tbStartEvent =
			{
