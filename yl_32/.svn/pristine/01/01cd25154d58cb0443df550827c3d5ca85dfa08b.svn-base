...
tbMultiSetting[301]=
{
	...
	-- 		编号  	npc模板				等级(-1默认随机npcpro表)	5行(默认-1)
        [1] = {nTemplate = 1300, nLevel = -1, nSeries = -1},		-- 第1层（房1）             第一层
		[2] = {nTemplate = 1301, nLevel = -1, nSeries = -1},		-- 第1层（房2）
		[3] = {nTemplate = 1302, nLevel = -1, nSeries = -1},		-- 第1层（房3）
		[4] = {nTemplate = 1303, nLevel = -1, nSeries = -1},		-- 第1层（房4）
		[5] = {nTemplate = 1304, nLevel = -1, nSeries = -1},		-- 第1层（真宝箱）
		[6] = {nTemplate = 1305, nLevel = -1, nSeries = -1},		-- 第1层（假宝箱）
		[7] = {nTemplate = 1306, nLevel = -1, nSeries = -1},		-- 第1层（假宝箱）
		[8] = {nTemplate = 1307, nLevel = -1, nSeries = -1},		-- 第1层（假宝箱）
		[9] = {nTemplate = 1308, nLevel = -1, nSeries = -1},		-- 第1层（返回水晶）真的
		[10] = {nTemplate = 1309, nLevel = -1, nSeries = -1},		-- 第1层（返回水晶）
		[11] = {nTemplate = 1310, nLevel = -1, nSeries = -1},		-- 第1层（宝物猴）
		[12] = {nTemplate = 1311, nLevel = -1, nSeries = -1},		-- 第1层（进入下一层）
		[13] = {nTemplate = 1312, nLevel = -1, nSeries = -1},		-- 第1层（假宝箱特效）
		[14] = {nTemplate = 1313, nLevel = -1, nSeries = -1},		-- 第1层（假宝箱特效）
		[15] = {nTemplate = 1314, nLevel = -1, nSeries = -1},		-- 第1层（假宝箱特效?
		[16] = {nTemplate = 1315, nLevel = -1, nSeries = -1},		-- 第2层（房1）            第二层
		[17] = {nTemplate = 1316, nLevel = -1, nSeries = -1},		-- 第2层（房2）
		[18] = {nTemplate = 1317, nLevel = -1, nSeries = -1},		-- 第2层（房3）
		[19] = {nTemplate = 1318, nLevel = -1, nSeries = -1},		-- 第2层（房4）
		[20] = {nTemplate = 1319, nLevel = -1, nSeries = -1},		-- 第2层（真宝箱）
		[21] = {nTemplate = 1320, nLevel = -1, nSeries = -1},		-- 第2层（假宝箱）
	    [22] = {nTemplate = 1321, nLevel = -1, nSeries = -1},		-- 第2层（假宝箱）
	    [23] = {nTemplate = 1322, nLevel = -1, nSeries = -1},		-- 第2层（假宝箱）
		[24] = {nTemplate = 1323, nLevel = -1, nSeries = -1},		-- 第2层（返回水晶）真的
		[25] = {nTemplate = 1324, nLevel = -1, nSeries = -1},		-- 第2层（返回水晶）
		[26] = {nTemplate = 1325, nLevel = -1, nSeries = -1},		-- 第2层（宝物猴）
		[27] = {nTemplate = 1326, nLevel = -1, nSeries = -1},		-- 第2层（进入下一层）
		[28] = {nTemplate = 1327, nLevel = -1, nSeries = -1},		-- 第2层（假宝箱特效）
		[29] = {nTemplate = 1328, nLevel = -1, nSeries = -1},		-- 第2层（假宝箱特效）
		[30] = {nTemplate = 1329, nLevel = -1, nSeries = -1},		-- 第2层（假宝箱特效?
		[31] = {nTemplate = 1330, nLevel = -1, nSeries = -1},		-- 第3层（房1）            第三层
		[32] = {nTemplate = 1331, nLevel = -1, nSeries = -1},		-- 第3层（房2）
		[33] = {nTemplate = 1332, nLevel = -1, nSeries = -1},		-- 第3层（房3）
		[34] = {nTemplate = 1333, nLevel = -1, nSeries = -1},		-- 第3层（房4）
		[35] = {nTemplate = 1334, nLevel = -1, nSeries = -1},		-- 第3层（真宝箱）
		[36] = {nTemplate = 1335, nLevel = -1, nSeries = -1},		-- 第3层（假宝箱）
	    [37] = {nTemplate = 1336, nLevel = -1, nSeries = -1},		-- 第3层（假宝箱）
	    [38] = {nTemplate = 1337, nLevel = -1, nSeries = -1},		-- 第3层（假宝箱）
		[39] = {nTemplate = 1338, nLevel = -1, nSeries = -1},		-- 第3层（返回水晶）真的
		[40] = {nTemplate = 1339, nLevel = -1, nSeries = -1},		-- 第3层（返回水晶）
		[41] = {nTemplate = 1340, nLevel = -1, nSeries = -1},		-- 第3层（宝物猴）
		[42] = {nTemplate = 1341, nLevel = -1, nSeries = -1},		-- 第3层（进入下一层）
		[43] = {nTemplate = 1342, nLevel = -1, nSeries = -1},		-- 第3层（假宝箱特效）
		[44] = {nTemplate = 1343, nLevel = -1, nSeries = -1},		-- 第3层（假宝箱特效）
		[45] = {nTemplate = 1344, nLevel = -1, nSeries = -1},		-- 第3层（假宝箱特效?
		[46] = {nTemplate = 1345, nLevel = -1, nSeries = -1},		-- 对水晶加特效
		[47] = {nTemplate = 1346, nLevel = 35, nSeries = -1},		-- 四兽塔塔主
	},
       ...
       -- 1号锁不能不填，默认1号为起始锁
		...
		[2] = {nTime = 0, nNum = 1 ,		-- 锁通过的条件（时间倒计时，杀怪个数）
			...
			tbStartEvent =
			{
				...
				--{MultiInstance.TIME_INFO, "<color=yellow>         四兽宝塔\\r\\r<color=green>副本剩余时间：%s"},
				--{MultiInstance.TARGET_INFO, "<color=yellow>副本玩法：<color=white>\\r点击<color=green>神兽宝珠<color=white>进入密室开宝箱\\r\\r真宝箱会开启出<color=green>限时宝物猴<color=white>\\r\\r宝物猴被打败开启下一层\\r\\r<color=yellow>目标：进入第四层消灭四兽塔塔主\\r", 1},
			},
			tbUnLockEvent =
			{
		...
		[7] = {nTime = 2, nNum = 0 ,		--
			...
			{   --
				...
				--{MultiInstance.TARGET_INFO, "目标：开启真正的宝箱", 2}, --
		...
		[8] = {nTime = 0, nNum = 1 ,		-- 锁通过的条件（时间倒计时，杀怪个数）
			...
			tbStartEvent =
			{
				...
				--{MultiInstance.TARGET_INFO, "目标：开启真正的宝箱", 5}, --
			},
			tbUnLockEvent =
			{
