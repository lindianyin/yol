...
tbMultiSetting[302]=
{
	...
	-- 		编号  	npc模板				等级(-1默认随机npcpro表)	5行(默认-1)
		...
		[2] = {nTemplate = 1381, nLevel = 45, nSeries = -1},		-- 点1-巡逻
		[3] = {nTemplate = 1382, nLevel = 45, nSeries = -1},		-- 点1-巡逻
		[4] = {nTemplate = 1383, nLevel = 45, nSeries = -1},		-- 支援(通用)
		[5] = {nTemplate = 1384, nLevel = -1, nSeries = -1},		-- 被杀（通用）
		[6] = {nTemplate = 1385, nLevel = 45, nSeries = -1},		-- 点2-巡逻
		[7] = {nTemplate = 1386, nLevel = 45, nSeries = -1},		-- 点3-巡逻
		[8] = {nTemplate = 1387, nLevel = 45, nSeries = -1},		-- 左桥1-巡逻
		[9] = {nTemplate = 1388, nLevel = 45, nSeries = -1},		-- 左桥2-巡逻
		[10] = {nTemplate = 1389, nLevel = 45, nSeries = -1},		-- 右桥1-巡逻
		[11] = {nTemplate = 1390, nLevel = 45, nSeries = -1},		-- 右桥2-巡逻
		[12] = {nTemplate = 1391, nLevel = 45, nSeries = -1},		-- 寨主boss
    ...
    LOCK =
    {
       -- 1号锁不能不填，默认1号为起始锁
		...
		[4] = {nTime = 2, nNum = 0 ,		-- 锁通过的条件（时间倒计时，杀怪个数）
			...
			tbUnLockEvent =
			{
				{MultiInstance.ADD_NPC, 4, 5, 4, "shibing1", "shibing1"},
			},
		},
		...
		[6] = {nTime = 2, nNum = 0 ,		-- 锁通过的条件（时间倒计时，杀怪个数）
			...
			tbUnLockEvent =
			{
				{MultiInstance.ADD_NPC, 4, 5, 6, "shibing2", "shibing2"},
			},
		},
		...
		[8] = {nTime = 2, nNum = 0 ,		-- 锁通过的条件（时间倒计时，杀怪个数）
			...
			tbUnLockEvent =
			{
				{MultiInstance.ADD_NPC, 4, 5, 8, "shibing3", "shibing3"},
			},
		},
