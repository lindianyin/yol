       ...
       -- 1号锁不能不填，默认1号为起始锁
		[1] = {nTime = 1, nNum = 0,		-- 总计时
			...
			tbStartEvent =
			{
				...
				{MultiInstance.SHOW_NOTICE_MSG, Lang.mission.str1153[Lang.Idx]},
			},
			tbUnLockEvent =
			{
			},
		...
		[2] = {nTime = 900, nNum = 0 ,		-- 时间倒计时，时间到了，系统会自动走退出流程
			...
			tbStartEvent =
			{
                {MultiInstance.TIME_INFO, Lang.mission.str1154[Lang.Idx]},
			   {MultiInstance.SHOW_NOTICE_MSG, Lang.mission.str1155[Lang.Idx]},
			},
			tbUnLockEvent =
			{
			},
		...
		[11] = {nTime = 0, nNum = 26 ,		-- 第一节点：消灭所有魔兵
			tbPrelock = {1},
			tbStartEvent =
			{
              {MultiInstance.ADD_NPC, 11, 14, 11, "mobing", "mobing"},
			   ...
			   {MultiInstance.ADD_NPC, 14, 1, 11, "mobing2", "mobing2"},
				{MultiInstance.TARGET_INFO, Lang.mission.str1156[Lang.Idx]},
			},
			tbUnLockEvent =
			{
		...
		[13] = {nTime = 0, nNum = 1 ,		-- 第二节点：消灭怨灵
			...
			tbStartEvent =
			{
			   ...
			   {MultiInstance.ADD_NPC, 16, 1, 13, "shengguang", "shengguang", 100, 10,"shengguang_timer"},
				{MultiInstance.TARGET_INFO, Lang.mission.str1157[Lang.Idx]},
			},
			tbUnLockEvent =
			{
		...
		[19] = {nTime = 0, nNum = 1 ,		-- 第四节点：消灭BOSS妖王
			...
			tbStartEvent =
			{
			   ...
			   {MultiInstance.NPC_BUBBLE, "yaowang",Lang.mission.str1150[Lang.Idx], 2},
				{MultiInstance.TARGET_INFO, Lang.mission.str1158[Lang.Idx]},
			},
			tbUnLockEvent =
			{
			{MultiInstance.DEL_ALL_NPC},              --删除所有NPC
			 {MultiInstance.SHOW_NOTICE_MSG, Lang.mission.str1159[Lang.Idx]},
			},
		},
		...
		[33] = {nTime = 5, nNum = 0 ,		-- 通过后处理总计时
			...
			tbStartEvent =
			{
				...
				{MultiInstance.TIME_INFO, Lang.mission.str1160[Lang.Idx], 4},
			},
			tbUnLockEvent =
			{
