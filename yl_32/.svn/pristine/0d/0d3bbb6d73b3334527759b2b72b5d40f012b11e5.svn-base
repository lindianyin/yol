...
tbStageSetting[4] =
{
	...
	-- 		编号  	npc模板				等级(-1默认随机npcpro表)	5行(默认-1)
		   ...
		   [2] = {nTemplate = 1001, nLevel = 30, nSeries = -1},		-- 石头中1
		   [3] = {nTemplate = 1002, nLevel = 30, nSeries = -1},		-- 石头中2
		   [4] = {nTemplate = 1003, nLevel = 30, nSeries = -1},		-- 石头左1
		   [5] = {nTemplate = 1004, nLevel = 30, nSeries = -1},		-- 石头左2
		   [6] = {nTemplate = 1005, nLevel = 30, nSeries = -1},		-- 石头右1
		   [7] = {nTemplate = 1006, nLevel = 30, nSeries = -1},		-- 石头右2
		   [8] = {nTemplate = 1007, nLevel = 25, nSeries = -1},		-- 自杀
		   [9] = {nTemplate = 1008, nLevel = 25, nSeries = -1},		-- 定时炸弹
		   [10] = {nTemplate = 1009, nLevel = 30, nSeries = -1},		-- 石龟
		   ...
		   [15] = {nTemplate = 1014, nLevel = 30, nSeries = -1},		-- 超级巨石（山坡）
		   [16] = {nTemplate = 1015, nLevel = 30, nSeries = -1},		-- 超级巨石（山坡）
		   ...
		   [21] = {nTemplate = 1022, nLevel = 30, nSeries = -1},		-- 巨石怪（攻击）
		   [22] = {nTemplate = 1023, nLevel = 30, nSeries = -1},		-- 石头支援BOSS
		   [23] = {nTemplate = 1024, nLevel = 30, nSeries = -1},		-- 石头支援BOSS
		   [24] = {nTemplate = 1025, nLevel = 30, nSeries = -1},		-- 石头支援BOSS
		   [25] = {nTemplate = 1026, nLevel = -1, nSeries = -1},		-- 透明被杀
		   [26] = {nTemplate = 1027, nLevel = 30, nSeries = -1},		-- 石龟
		   [27] = {nTemplate = 1028, nLevel = 30, nSeries = -1},		-- 炸弹龟
		   [28] = {nTemplate = 1029, nLevel = 1, nSeries = -1},		-- 透明目标
		   [29] = {nTemplate = 1017, nLevel = 30, nSeries = -1},		-- 石头新增左
		   [30] = {nTemplate = 1018, nLevel = 30, nSeries = -1},		-- 石头新增右
	},
...
tbStageSetting[5]=
{
	...
	-- 		编号  	npc模板				等级(-1默认)	5行(默认-1)
		   ...
		   [19] = {nTemplate = 1068, nLevel = 30, nSeries = -1},		-- 缸
