...
tbMultiSetting[318]=
{
	...
	-- 		编号  	npc模板				等级(-1默认随机npcpro表)	5行(默认-1)
		...
		[2] = {nTemplate = 1421, nLevel = 30, nSeries = -1},        --劫匪（戴帽）
		[3] = {nTemplate = 1422, nLevel = 30, nSeries = -1},        --劫匪（没戴帽）
		[4] = {nTemplate = 1423, nLevel = 30, nSeries = -1},        --劫匪(自由)
		[5] = {nTemplate = 1424, nLevel = 30, nSeries = -1},        --大劫匪
		[6] = {nTemplate = 1425, nLevel = 30, nSeries = -1},        --帐篷
		[7] = {nTemplate = 1426, nLevel = 30, nSeries = -1},        --箭塔
		[8] = {nTemplate = 1427, nLevel = -1, nSeries = -1},        --被踩自杀
		[9] = {nTemplate = 1428, nLevel = -1, nSeries = -1},        --出来自杀
		[10] = {nTemplate = 1429, nLevel = 30, nSeries = -1},        --劫匪头领
    ...
    LOCK =
    {
       -- 1号锁不能不填，默认1号为起始锁
		...
		[3] = {nTime = 0, nNum = 1 ,		-- 锁通过的条件（时间倒计时，杀怪个数）
			...
			tbStartEvent =
			{
				{MultiInstance.ADD_NPC, 4, 7, 2, "ziyou", "ziyou"},                    --自由劫匪
				{MultiInstance.ADD_NPC, 5, 2, 2, "da", "ziyou"},
			},
			tbUnLockEvent =
			{
			    {MultiInstance.ADD_NPC, 5, 1, 2, "dajiefei", "dajiefei", 4, 20,"dajiefei_timer",0},      --大劫匪
