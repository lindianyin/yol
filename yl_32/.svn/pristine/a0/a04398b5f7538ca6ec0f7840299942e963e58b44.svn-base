...
ActivitySetting[22] =
{
	...
	tbOpenTimes = {{{ wday=1,hour=19, min=30, sec=0}, {wday=1,hour=20, min=0, sec=0}},{{ wday=2,hour=19, min=30, sec=0}, {wday=2,hour=20, min=0, sec=0}},{{ wday=4,hour=19, min=30, sec=0}, {wday=4,hour=20, min=0, sec=0}},{{ wday=6,hour=19, min=30, sec=0}, {wday=6,hour=20, min=0, sec=0}}},	--开放时间{StartTime, EndTime},9分钟，开几次，填几组时间, 每组时间不能重叠
	ActivityName = Lang.mission.str88[Lang.Idx],         -- 活动名字，输出信息用
	nStartStep = 1,			   	          -- 开始步骤，记录进入位置
	tbEnterPos = { nMapId = 346, tbPos = {{1726,2280,1048576}}},		-- 准备场进入点
...
ActivitySetting[22].Enemy1 = Team + Team_Enable + Not;  --非队友的人全都是敌人
--ActivitySetting[2].Enemy2 = 0;

-- 步骤定义分开写，不然层次太多很容易乱
local STEP = ActivitySetting[22].STEP
...
STEP[1] =
{
	...
	Pos = {346,{1155,2074,1048576},{1083,2657,1048576},{1452,2931,1048576},{1946,2686,1048576},{2123,2336,1048576},{1638,1716,1048576},{1500,2352,1048576}},                         --玩家默认传送的位置
...
STEP[2] =                                                        --世界boss准备场
{
	...
	Pos = {350,{4501,1107,1048576},{4497,7368,1048576}},
	NPC =
	{
		-- 		编号  	npc模板				等级(-1默认)	5行(默认-1)
