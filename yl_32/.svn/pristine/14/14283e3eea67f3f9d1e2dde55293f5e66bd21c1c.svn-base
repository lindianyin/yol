...
tbRoom[28] =    --水莫研
{
	...
	nMapIndex		= 5,						-- 地图组的索引
	tbBeginPoint	= {819, 1004, 1055226},	-- 起始点，格式根据fnPlayerGroup需求而定，默认是{nX,nY}
	-- 房间涉及的NPC种类
	NPC = 
	{
-- 		编号  	npc模板		等级(-1默认)(强度表id列)	5行(默认-1)
-- E.g  [0] = {nTemplate, 			nLevel, 		nSeries }
		[1] = {nTemplate = 8015, nLevel = {8041,8042,8043}, nSeries = -1},		-- 水莫言
		[2] = {nTemplate = 8018, nLevel = {8050,8050,8050}, nSeries = -1},		-- 柱子
	},
	-- 锁结构
	LOCK = 
	{
		...
		[3] = {nTime = 0, nNum = 1,
			...
			tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 1, 3, "boss", "shuimy8015"},		-- 刷怪
