...
tbMultiSetting[502]=
{
	...
	-- 		编号  	npc模板				等级(-1默认随机npcpro表)	5行(默认-1)
        [1] = {nTemplate = 1250, nLevel = 45, nSeries = -1},		-- 狂暴黑熊
		[2] = {nTemplate = 1251, nLevel = 45, nSeries = -1},		-- 牛兵守卫
		[3] = {nTemplate = 1252, nLevel = 45, nSeries = -1},		-- 牛魔王
		[4] = {nTemplate = 1253, nLevel = 45, nSeries = -1},		-- 凶残鸟人
		[5] = {nTemplate = 1254, nLevel = 45, nSeries = -1},		-- 大头领
		[6] = {nTemplate = 1255, nLevel = 45, nSeries = -1},		-- 厚血蛤蟆
		[7] = {nTemplate = 1256, nLevel = 45, nSeries = -1},		-- 封印将军
		[8] = {nTemplate = 1257, nLevel = 45, nSeries = -1},		-- 大教主
		[9] = {nTemplate = 1258, nLevel = -1, nSeries = -1},		-- 神仙姐姐
		[10] = {nTemplate = 1259, nLevel = -1, nSeries = -1},		-- 回到起点（普通难度）
		[11] = {nTemplate = 1260, nLevel = -1, nSeries = -1},		-- 回到起点（困难难度）
       ...
       -- 1号锁不能不填，默认1号为起始锁
		...
		[2] = {nTime = 900, nNum = 0 ,
			...
			tbStartEvent =
			{
				...
				{MultiInstance.ADD_NPC, 10, 1, 2, "10", "paotaTransmit1"}, --回到起点
