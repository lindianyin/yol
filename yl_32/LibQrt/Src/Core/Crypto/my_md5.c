...
void Misc_MD5String(char *output, unsigned char * input,int  ilen)
{
	MD5_CTX context;
...
static void Encode (unsigned char * output, UINT4 * input, int len)
{
        ...
        for (i = 0, j = 0; j < (unsigned)len; i++, j += 4)
        {
