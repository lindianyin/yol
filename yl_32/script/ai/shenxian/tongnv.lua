...
function AI:Setup(ai)
    ...
    action.SetBranch(129, 77)
    g_AIDebugInfo[59] = '[59] SELECT_EVENT_SRC()'

    -- 将目标添加到威胁列表
    action = ai.NewAction(129, AI_ACTION.ADD_TARGET_TO_THREAT_LIST)
    action.SetBranch(49)
    g_AIDebugInfo[129] = '[129] ADD_TARGET_TO_THREAT_LIST()'
    ...
    action.SetParam(128, 1)
    action.SetBranch(64, 64)
    g_AIDebugInfo[30] = '[30] CAST_SKILL(128, 1)'
    ...
    action.SetParam(129, 1)
    action.SetBranch(38, 38)
    g_AIDebugInfo[63] = '[63] CAST_SKILL(129, 1)'
