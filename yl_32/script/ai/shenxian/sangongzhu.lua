...
function AI:Setup(ai)
    ...
    action.SetBranch(130, 77)
    g_AIDebugInfo[59] = '[59] SELECT_EVENT_SRC()'

    -- 将目标添加到威胁列表
    action = ai.NewAction(130, AI_ACTION.ADD_TARGET_TO_THREAT_LIST)
    action.SetBranch(49)
    g_AIDebugInfo[130] = '[130] ADD_TARGET_TO_THREAT_LIST()'
    ...
    action.SetParam(131, 1)
    action.SetBranch(64, 64)
    g_AIDebugInfo[30] = '[30] CAST_SKILL(131, 1)'
    ...
    action.SetParam(130, 1)
    action.SetBranch(38, 38)
    g_AIDebugInfo[63] = '[63] CAST_SKILL(130, 1)'
