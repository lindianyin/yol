...
-- E.g  [0] = {nTemplate, 			nLevel, 		nSeries }
		[1] = {nTemplate = 9011, nLevel = {9011}, nSeries = -1},		-- 食肉蜂
		[2] = {nTemplate = 9030, nLevel = {9030}, nSeries = -1},		-- 吞食蜂
		[3] = {nTemplate = 9049, nLevel = {9030}, nSeries = -1},        --BOSS替身
	...
	[3] = {nTime = 0, nNum = 3,       --刷第一波怪
		tbPrelock = {1},
			tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 3, 3, "guaiwu", "shiroufeng9011"},		-- 刷怪
				{XoyoGame.ADD_NPC, 3, 1, 0, "tishen", "tishen9030"},
	...
	[4] = {nTime = 0, nNum = 3,      --刷第二批怪
		tbPrelock = {3},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 3, 4, "guaiwu", "shiroufeng9011"},		-- 刷怪
	...
	[5] = {nTime = 0, nNum = 4,      --刷第三批怪
		tbPrelock = {4},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 4,5, "guaiwu", "shiroufeng9011"},		-- 刷怪
	...
	[6] = {nTime = 0, nNum = 4,      --刷第四批怪
		tbPrelock = {5},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 4, 6, "guaiwu", "shiroufeng9011"},		-- 刷怪
	...
	[7] = {nTime = 0, nNum = 4,      --刷第五批怪
		tbPrelock = {6},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 4, 7, "guaiwu", "shiroufeng9011"},		-- 刷怪
	...
	[8] = {nTime = 0, nNum = 5,      --刷第六批怪
		tbPrelock = {7},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 5,8, "guaiwu", "shiroufeng9011"},		-- 刷怪
	...
	[9] = {nTime = 0, nNum = 5,      --刷第七批怪
		tbPrelock = {8},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 5, 9, "guaiwu", "shiroufeng9011"},		-- 刷怪
	...
	[10] = {nTime = 0, nNum = 6,      --刷第八批怪
		tbPrelock = {9},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 6, 10, "guaiwu", "shiroufeng9011"},		-- 刷怪
	...
	[11] = {nTime = 0, nNum = 6,      --刷第九批怪
		tbPrelock = {10},
		    tbStartEvent = 
			{
				{XoyoGame.ADD_NPC, 1, 6, 11, "guaiwu", "shiroufeng9011"},		-- 刷怪
	...
	[12] = {nTime = 0, nNum = 5,      --刷BOSS
		tbPrelock = {11},
			...
			{
				{XoyoGame.DEL_NPC, "tishen"},
				{XoyoGame.ADD_NPC, 1, 4, 12, "guaiwu", "shiroufeng9011"},		-- 刷怪
				{XoyoGame.ADD_NPC, 2, 1, 12, "boss", "tunshifeng9030"},		-- 刷怪
				{XoyoGame.TARGET_INFO, -1, Lang.mission.str590[Lang.Idx],12},
