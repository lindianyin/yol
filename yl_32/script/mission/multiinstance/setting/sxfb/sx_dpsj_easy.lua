    ...
    LOCK =
    {
       -- 1号锁不能不填，默认1号为起始锁
		...
		[7] = {nTime = 7, nNum = 0 ,
			...
			tbStartEvent =
			{
				{MultiInstance.ADD_NPC, 1, 1, 2, "1", "chuansong1"},
				--{MultiInstance.ADD_NPC, 2, 1, 2, "2", "chuansong2"},
		...
		[9] = {nTime = 0, nNum = 21 ,
			...
			tbUnLockEvent =
			{
				--{MultiInstance.ADD_NPC, 3, 1, 2, "3", "chuansong3"},
				{MultiInstance.ADD_NPC, 4, 1, 2, "4", "chuansong4"},    --神界
			},
		},
		[10] = {nTime = 0, nNum = 1 ,
			tbPrelock = {9},
		...
		[11] = {nTime = 0, nNum = 26 ,
			...
			tbUnLockEvent =
			{
				--{MultiInstance.ADD_NPC, 5, 1, 2, "5", "chuansong5"},
				{MultiInstance.ADD_NPC, 6, 1, 2, "6", "chuansong6"},    --魔
