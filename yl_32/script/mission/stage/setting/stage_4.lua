...
tbStageSetting[10] =
{
	...
	-- 		编号  	npc模板				等级(-1默认随机npcpro表)	5行(默认-1)
		   ...
		   [27] = {nTemplate = 1028, nLevel = 40, nSeries = -1},		-- 炸弹龟
...
tbStageSetting[11]=
{
	...
	-- 		编号  	npc模板				等级(-1默认)	5行(默认-1)
		   ...
		   [11] = {nTemplate = 1060, nLevel = 40, nSeries = -1},		-- 魔兵
		   [12] = {nTemplate = 1061, nLevel = 40, nSeries = -1},		-- 魔兵弓箭手
		   [13] = {nTemplate = 1062, nLevel = 40, nSeries = -1},		-- 魔将
		   [14] = {nTemplate = 1063, nLevel = 40, nSeries = -1},		-- 魔将
		   [15] = {nTemplate = 1064, nLevel = 40, nSeries = -1},		-- 怨灵
		   [16] = {nTemplate = 1065, nLevel = -1, nSeries = -1},		-- 圣光
		   [17] = {nTemplate = 1066, nLevel = 40, nSeries = -1},		-- 妖王
		    [18] = {nTemplate = 1067, nLevel = -1, nSeries = -1},		-- 一出来就自杀
		   [19] = {nTemplate = 1068, nLevel = 40, nSeries = -1},		-- 缸
		   [20] = {nTemplate = 1069, nLevel = 1, nSeries = -1},		-- 人踩自杀
		   [21] = {nTemplate = 1070, nLevel = 40, nSeries = -1},		-- 鬼魂
		   [22] = {nTemplate = 1071, nLevel = 40, nSeries = -1},		-- 鬼魂
		   [23] = {nTemplate = 1072, nLevel = 40, nSeries = -1},		-- 鬼魂
		   [24] = {nTemplate = 1073, nLevel = 40, nSeries = -1},		-- 鬼魂
		    [25] = {nTemplate = 1074, nLevel = 40, nSeries = -1},		-- 凶猛鬼魂
			[26] = {nTemplate = 1075, nLevel = 40, nSeries = -1},		-- 召唤鬼魂
		   [27] = {nTemplate = 1076, nLevel = 40, nSeries = -1},		-- 召唤鬼魂
		   [28] = {nTemplate = 1077, nLevel = 40, nSeries = -1},		-- 召唤鬼魂
		   [29] = {nTemplate = 1078, nLevel = 40, nSeries = -1},		-- 召唤鬼魂
		   [30] = {nTemplate = 1079, nLevel = -1, nSeries = -1},		-- 透明被杀
			...
			[34] = {nTemplate = 1083, nLevel = 40, nSeries = -1},		-- 凶鬼
	},
    LOCK =
    {
       -- 1号锁不能不填，默认1号为起始锁
