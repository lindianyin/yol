...
ActivitySetting[20] =
{
	...
	tbEnterPos = { nMapId = 340, tbPos = {{1155,2074,1048576},{1083,2657,1048576},{1452,2931,1048576},{1946,2686,1048576},{2123,2336,1048576},{1638,1716,1048576},{1500,2352,1048576}}},		-- 准备场进入点
...
ActivitySetting[20].Enemy1 = Team + Team_Enable + Not;  --非队友的人全都是敌人
--ActivitySetting[2].Enemy2 = 0;

-- 步骤定义分开写，不然层次太多很容易乱
local STEP = ActivitySetting[20].STEP
...
STEP[1] =
{
	...
	Pos = {340,{1155,2074,1048576},{1083,2657,1048576},{1452,2931,1048576},{1946,2686,1048576},{2123,2336,1048576},{1638,1716,1048576},{1500,2352,1048576}},        --玩家默认传送的位置
	NPC =
	{
...
STEP[2] =                                                        --世界boss准备场
{
	...
	Pos = {339,{4501,1107,1048576},{4497,7368,1048576}},
	NPC =
	{
		-- 		编号  	npc模板				等级(-1默认)	5行(默认-1)
