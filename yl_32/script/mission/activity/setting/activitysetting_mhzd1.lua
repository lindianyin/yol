...
ActivitySetting[31] =
{
	...
	ActivityName = Lang.mission.str1135[Lang.Idx],        -- 活动名字，输出信息用
	nStartStep = 1,			   	          -- 开始步骤，记录进入位置
  tbEnterPos = { nMapId = 354, tbPos = {{7002,6405,1048576},{6674,7215,1048576},{3660,6905,1048576},{1068,4879,1048576},{3375,3083,1048576},{5771,4702,1048576},{6478,1429,1048576},{2081,1109,1048576}}},		-- 进入点
...
--ActivitySetting[31].Enemy1 = Team + Team_Enable + Not;  --非队友的人全都是敌人
...
STEP[1] =
{
	...
	Pos = {354,{7002,6405,1048576},{6674,7215,1048576},{3660,6905,1048576},{1068,4879,1048576},{3375,3083,1048576},{5771,4702,1048576},{6478,1429,1048576},{2081,1109,1048576}},                         --玩家默认传送的位置
	NPC =
	{
-- 		编号  	npc模板				等级(-1默认)	5行(默认-1)
		[1] = {nTemplate = 2802, nLevel = -1, nSeries = -1},		--荒漠刀客
       ...
       -- 1号锁不能不填，默认1号为起始锁
		...
		[2] = {nTime = 86389, nNum = 0,
			...
			tbStartEvent =
			{
				...
				{Activity.EVENT_TYPE.ADD_NPC_ON_TIME,080000, 5, 1, 2,"boss","boss"},  --14点刷出boss3
				{Activity.EVENT_TYPE.ADD_NPC_ON_TIME,160000, 6, 1, 2,"boss","boss"},  --18点刷出boss5
