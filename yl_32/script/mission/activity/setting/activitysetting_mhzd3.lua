...
ActivitySetting[33] =
{
	...
	ActivityName = Lang.mission.str1137[Lang.Idx],        -- 活动名字，输出信息用
	nStartStep = 1,			   	          -- 开始步骤，记录进入位置
	tbEnterPos = { nMapId = 356, tbPos = {{5243,1835,1048576},{3632,1665,1048576},{5996,3910,1048576},{2548,6576,1048576},{2542,4462,1048576},{3058,1656,1048576},{2677,2873,1048576},{4204,4706,1048576}}},		-- 进入点
...
ActivitySetting[33].Enemy1 = Team + Team_Enable + Not;  --非队友的人全都是敌人
...
STEP[1] =
{
	...
	Pos = {356,{5243,1835,1048576},{3632,1665,1048576},{5996,3910,1048576},{2548,6576,1048576},{2542,4462,1048576},{3058,1656,1048576},{2677,2873,1048576},{4204,4706,1048576}},                         --玩家默认传送的位置
	NPC =
	{
-- 		编号  	npc模板				等级(-1默认)	5行(默认-1)

		[1] = {nTemplate = 2804, nLevel = -1, nSeries = -1},		--暗黑魔牛
       ...
       -- 1号锁不能不填，默认1号为起始锁
		...
		[2] = {nTime = 86389, nNum = 0,
			...
			tbStartEvent =
			{
				...
				{Activity.EVENT_TYPE.ADD_NPC_ON_TIME,120000, 8, 1, 2,"boss","boss"}, --22点刷出boss7
				{Activity.EVENT_TYPE.ADD_NPC_ON_TIME,200000, 8, 1, 2,"boss","boss"}, --22点刷出boss7
