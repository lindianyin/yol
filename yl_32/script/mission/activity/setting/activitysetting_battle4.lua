...
ActivitySetting[24] =
{
	...
	tbEnterPos = { nMapId = 348, tbPos = {{1726,2280,1048576}}},		-- 准备场进入点
...
ActivitySetting[24].Enemy1 = Team + Team_Enable + Not;  --非队友的人全都是敌人
--ActivitySetting[2].Enemy2 = 0;

-- 步骤定义分开写，不然层次太多很容易乱
local STEP = ActivitySetting[24].STEP
...
STEP[1] =
{
	...
	Pos = {348,{1155,2074,1048576},{1083,2657,1048576},{1452,2931,1048576},{1946,2686,1048576},{2123,2336,1048576},{1638,1716,1048576},{1500,2352,1048576}},                         --玩家默认传送的位置
...
STEP[2] =                                                        --世界boss准备场
{
	...
	Pos = {352,{4501,1107,1048576},{4497,7368,1048576}},
	NPC =
	{
		-- 		编号  	npc模板				等级(-1默认)	5行(默认-1)
