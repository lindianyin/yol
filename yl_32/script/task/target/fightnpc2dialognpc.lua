...
function tb:Init(nMapId, nMapPosX, nMapPosY, nMapPosZ, nFightNpcTempId, nFightNpcLevel, nDialogNpcTempId, szOption, szMsg, szRepeatMsg, nDialogDuration, szStaticDesc, szDynamicDesc, szBeforePop, szLaterPop)
	self.nMapId				= nMapId;
