...
local tb	= Task:GetTarget("UpgradeEquip");
tb.szTargetName	= "UpgradeEquip";
tb.REFRESH_FRAME	= 18;	-- 一秒检测一次

function tb:Init(szStaticDesc, szDynamicDesc, nEquipDetail, nTargetLevel)
...
function tb:Start()
	...
	if pEquip.nLevel < self.nTargetLevel then
	    self.bDone = 0;
	end
