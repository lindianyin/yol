...
private:
	...
	BOOL SendPlayerMail(DWORD dwSenderId, KRole* pReceiver, KMAIL_INFO* pMail);
	BOOL SendSystemMail(KRole* pReceiver, KMAIL_INFO* pMail);
	BOOL SendDeliveryMail(DWORD dwSenderId, KRole* pReceiver, KMAIL_INFO* pMail);
