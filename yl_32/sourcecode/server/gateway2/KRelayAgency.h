...
public:
	...
	BOOL DoRandomNameRequest(INT nPlayerIndex, INT nSex);
	...
	BOOL DoIBBuySingleItemResult(KIBAccountBuyItemRet* pResult, DWORD dwServerId, UINT uPackageId);
	BOOL DoIBBuyMultiItemResult(KIBAccountBuyMultiItemRet* pResult, DWORD dwServerId, UINT uPackageId);
...
private:
	...
	void OnSyncRandomName(BYTE* pbyData, size_t uDataLen);
	...
	void OnKickoutAccount(BYTE* pbyData, size_t uDataLen);
	void OnIBBuySingleItem(BYTE* pbyData, size_t uDataLen);
	void OnIBBuyMultiItem(BYTE* pbyData, size_t uDataLen);
